...
public partial class FisioContext : DbContext
{
    ...
    public virtual DbSet<DiagnosticoFormularioSeccion> DiagnosticoFormularioSecciones { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Diagnostico>(entity =>
        {
            ...
            entity.Property(e => e.SeccionesDinamicasJson)
        ...
        modelBuilder.Entity<DiagnosticoFormularioSeccion>(entity =>
        {
            entity.ToTable("diagnostico_formulario_seccion");

            entity.HasKey(e => e.DiagnosticoFormularioSeccionId);
